...
> [!NOTE]
> Para definições detalhadas de **Simplex** e **Platform** (Estrutura de Diretórios, Geraçao de Código, UIComponents), consulte os arquivos `.mentor/knowledge/Simplex.md` e `.mentor/knowledge/Platform.md`.

> [!IMPORTANT]
> **Registro de Prompts e Lições Aprendidas**: Para cada prompt do usuário, você deve registrar o horário de início/fim, o objetivo e as melhorias para o futuro, visando retroalimentar a IA. Consulte as regras exatas no arquivo `.mentor/knowledge/LessonsLearned.md`.
