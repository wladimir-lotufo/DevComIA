...
This workflow creates or updates a component page in `.mentor/knowledge/DesignSystem/components/{category}/` based on a UIComponent input, while preserving recent layout adjustments.
...
3. **Check if Component File Exists**
   - Look for the file at `.mentor/knowledge/DesignSystem/components/{category}/{componentname}.html`
...
8. **Save the Component File**
   - Write to `.mentor/knowledge/DesignSystem/components/{category}/{componentname}.html`
...
- [newbutton.html](file:///c:/Users/wladi/source/repos/PartnerShip/.mentor/knowledge/DesignSystem/components/botoes/newbutton.html) - **PRIMARY REFERENCE** - Complete 4-column configuration template
- [actionedit.html](file:///c:/Users/wladi/source/repos/PartnerShip/.mentor/knowledge/DesignSystem/components/acoes/actionedit.html) - Action button with 4-column configuration
- [alert.html](file:///c:/Users/wladi/source/repos/PartnerShip/.mentor/knowledge/DesignSystem/components/formularios/alert.html) - Alert with multiple configuration options
...
**Reference Components**:
- [text.html](file:///c:/Users/wladi/source/repos/PartnerShip/.mentor/knowledge/DesignSystem/components/dados/text.html) - Text input with context selector
- [select.html](file:///c:/Users/wladi/source/repos/PartnerShip/.mentor/knowledge/DesignSystem/components/dados/select.html) - Select dropdown with context selector
