...
- **Inputs:**
    ...
    3. **Prototype File:** The HTML prototype file located in `docs/ai/design/prototypes\{ViewName}.html`
...
- **Steps:**
    1. **Verify Controller Name:** 
        ...
        - Ask the user which User Story this view is based on.
        - Load the User Story file from `docs/ai/requirements/user-stories/{ViewName}/`.
    
    2. **Analyze Prototype and Data Requirements:**
        - Read the prototype HTML file from `docs/ai/design/prototypes\{ViewName}.html`.
